...
\begin{itemize}
	...
	\item \textbf{Fácil instalación}: Jenkins es una aplicación auto-contenida diseñada con Java, lista para ser ejecutada \TODO{ out-of-the-box} y empaquetada para los \gls{SO} Windows, Mac OSX, así como cualquier sistema Unix.
	...
	\item {Soporte de scripts}Ñ Puede ejecutar scripts de bash, shell, ANT y proyectos Maven.
	\item {Notificaciones}: Jenkins puede ser utilizado para publicar resultados y enviar emails de notificación de los mismos.
\end{itemize}
